...
namespace onboardor.Migrations
{
    ...
    [Migration("20181027105048_MultipleOnboardingProcesses")]
    partial class MultipleOnboardingProcesses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("onboardor.Components.dashboard.OnboardingPipeline", b =>
                {
                    ...
                    b.ToTable("OnboardingPipelines");
                });

            modelBuilder.Entity("onboardor.Components.dashboard.OnboardingProcess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("onboardor.Components.dashboard.OnboardingStep", b =>
                {
                    ...
                    b.Property<int?>("OnboardingPipelineId");

                    b.HasKey("Id");

                    b.HasIndex("OnboardingPipelineId");
            ...
            modelBuilder.Entity("onboardor.Components.dashboard.OnboardingStep", b =>
                {
                    b.HasOne("onboardor.Components.dashboard.OnboardingPipeline", "OnboardingPipeline")
                        .WithMany("OnboardingSteps")
                        .HasForeignKey("OnboardingPipelineId");
                });
