...
const TermsAndConditions = () => (
  <PageContent>
    ...
    <p>
      ...
      connection with the Site, such as ratings, reviews, compliments, invitations,
      ...
      or in connection with the Site. &quot;onboardor Content&quot; means Content that
      ...
      than onboardor or its users, which is made available in connection with the Site.
    ...
    <ol>
      ...
      <li>
        <h2>Disclaimer</h2>
        <p>
          The materials on the onboardor website are provided &quot;as shown&quot;.
          onboardor makes no warranties, expressed or implied, and hereby disclaims
          and negates all other warranties, including without limitation, implied
          warranties or conditions of merchantability, fitness for a particular
          purpose, or non-infringement of intellectual property or other violation of rights.
          Further, onboardor does not warrant or make any representations concerning the accuracy,
      ...
      <li>
        <h2>Limitations</h2>
        <p>
          In no event shall onboardor or its suppliers be liable for any damages (including, without
      ...
      <li>
        ...
        <p>
          ...
          or photographic errors. onboardor does not warrant that any of the materials on
      ...
      <li>
        <h2>Links</h2>
        <p>
          onboardor has not reviewed all of the sites linked to its internet website
      ...
      <li>
        <h2>Governing Law</h2>
        <p>
          Any claim relating to the onboardor website shall be governed by the laws
      ...
      <li>
        ...
        <p>
          In the event of a conflict between these Terms and a foreign language version
          of our Terms of Use, the English language version of these Terms governs.
          All disputes, claims and causes of action (and related proceedings) will be
          communicated in English.
        </p>
      </li>
      <li>
        <h2>Copyright policy, notice and claim information</h2>
        <p>
          All materials on this site, whether separate or compiled, including,
          ...
          therein, are owned or licensed by onboardor and its third-party information providers,
